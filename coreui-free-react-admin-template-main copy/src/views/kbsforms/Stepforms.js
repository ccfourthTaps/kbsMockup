...
const [progressitem,setProgress] = useState(0);
...
const onClickProgress = (Progress,tabs) => {
    ...
    <CRow>
      <CCol xs={12}>
          <CProgress className="mb-3">
            <CProgressBar value={progressitem}>{progressitem}%</CProgressBar>
          </CProgress>
      </CCol>
      <CCol xs={12}>
        <CCard  className="d-grid gap-2 d-md-flex justify-content-md-end text-center">
        ...
        <CTabContent>
            ...
            <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeTab === 1}>
              <CContainer>
                ...
                <CRow className="justify-content-center mb-4">
                  <CCol xs={4}>
                    <CButton onClick={() => onClickProgress(25,2)}>ถัดไป</CButton> 
                  </CCol>
                </CRow>
              </CContainer>
            </CTabPane>
            ...
            <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeTab === 2}>
              <CContainer>
                ...
                <CRow className="justify-content-center mb-4">
                  <CCol xs={4}>
                    <CButton onClick={() => onClickProgress(50,3)}>ถัดไป</CButton> <CButton color="warning"  onClick={() => onClickProgress(0,1)}>ย้อนกลับ</CButton>
                  </CCol>
                </CRow>
              </CContainer>
            </CTabPane>
            ...
            <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeTab === 3}>
              <CContainer>
                ...
                <CRow className="justify-content-center mb-4">
                  <CCol xs={4}>
                    <CButton onClick={() => onClickProgress(75,4)}>ถัดไป</CButton> <CButton color="warning" onClick={() => onClickProgress(50,2)}>ย้อนกลับ</CButton>
                  </CCol>
                </CRow>
              </CContainer>
            </CTabPane>
            ...
            <CContainer>
                ...
                <CRow className="justify-content-center mb-4">
                  <CCol xs={4}>
                    <CButton onClick={() => onClickProgress(100,4)}>บันทึก</CButton> <CButton color="warning" onClick={() => onClickProgress(75,3)}>ย้อนกลับ</CButton>
                  </CCol>
                </CRow>
              </CContainer>
            </CTabPane>
